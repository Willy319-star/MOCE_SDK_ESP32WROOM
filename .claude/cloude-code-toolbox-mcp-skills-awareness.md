...
_Generated: 2026-06-24T06:23:19.345Z_
...
Workspace `mcp.json` _(folder: moce_sdk)_

- **d:\moce_sdk\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\EDY\.claude.json** — _File exists — no servers defined_
